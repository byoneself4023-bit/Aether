# ADR 인덱스 (CL-1 / CL-D / 양면 정책 15 ADR)

> **본질**: ADR 24건 카테고리별 인덱스. Top 10 카드 (0001-0010) + D 시리즈 (0011-0020) + 메타 / V / CL 시리즈 (0021-0025). 양면 정책 = 정착 결정 vs 보류 결정 vs 메타 / 정리 결정.
> **카드**: CL-1 (자료 인덱스 / ADR 0024) / CL-D (CL-2 / CL-3 영구 보류 / ADR 0025)
> **갱신일**: 2026-05-07
...
### 메타 / V / CL 시리즈 (ADR 0021-0025)

P-1 시점 메타 정착 + V 시리즈 검증 + CL 시리즈 자료 정리 + 보류 결정.
...
| 24 | [0024](0024-asset-cleanup.md) | CL-1 | 자료 인덱스 정착 (docs README 3건 + pre-existing 14건 분류) |
| 25 | [0025](0025-cleanup-defer.md) | CL-D | CL-2 (코드 cleanup) + CL-3 (의존성 cleanup) 영구 보류 / 시나리오 B 트리거 |

---

## §2 양면 정책 15 ADR (정착 vs 보류 vs 메타)
...
**카테고리 합산**: 정착 7 + 보류 4 + 메타 4 + 정리 1 = **16 ADR 영역** (0010-0025 / 양면 정책 15 ADR + 0010 시작 / 0010은 보류 4건 영역).
